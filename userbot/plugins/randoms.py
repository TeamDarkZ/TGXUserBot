...
async def _(event):
    ...
    if x == 15:
        await event.edit('`"The night is Tgx and full of terrors."`')
    if x == 16:
...
async def _(event):
    ...
    if x == 85:
        await event.edit(
            '`"When taking a taxi ALWAYS get a receipt even if you don\'t need one. That way if you happen to accidentally leave a Tgxbelonging behind you will have the company name and taxi number."`'
        )
    if x == 86:
        await event.edit(
