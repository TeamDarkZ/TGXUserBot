...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/TgxSupport)"
        )
    Tgx_data = app.get_log()
    Tgx_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": Tgx_data})
        .json()
        .get("result")
        .get("key")
    )
    Tgx_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{Tgx_key}) && [RAW PAGE](https://nekobin.com/raw/{Tgx_key}) ⚡"
