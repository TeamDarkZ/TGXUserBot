...
LOVESTR = [
    ...
    "To love or have loved, that is enough. Ask nothing further. There is no other pearl to be found in the Tgx folds of life.",
...
GDNIGHT = [
    ...
    "`Tgxness cannot last forever. Keep the hope alive. Good night.`",
    ...
    "`May the Tgxness of the night cloak you in a sleep that is sound and good! Dear friend, may this feeling carry you through the next day!`",
...
GDMORNING = [
    ...
    "`The Tgxness of night has ended. A new sun is up there to guide you towards a life so bright and blissful. Good morning dear!`",
    ...
    "`Morning is not only sunrise but A Beautiful Miracle of God that defeats the Tgxness and spread light. Good Morning.`",
