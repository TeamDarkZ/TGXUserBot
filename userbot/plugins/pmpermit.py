...
from userbot import ALIVE_NAME, CUSTOM_PMPERMIT, Tgx_ID
...
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's TgxBot.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **TgxBot Ultra Private Security Protocol⚠️**.\n"
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def do_pm_permit_action(chat_id, event):
        ...
        r = await borg.send_file(
            event.chat_id, TgxPIC, caption=USER_BOT_NO_WARN, force_document=False
        )
        PM_WARNS[chat_id] += 1
        if chat_id in PREV_REPLY_MESSAGE:
            await PREV_REPLY_MESSAGE[chat_id].delete()
