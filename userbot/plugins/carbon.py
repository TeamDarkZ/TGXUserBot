...
async def carbon_api(e):
    ...
    Tgx = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await Tgx.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await Tgx.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await Tgx.edit("`Uploading..`")
...
async def carbon_api(e):
    if e.fwd_from:
        return
    Tgx = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
async def carbon_api(e):
    ...
    await Tgx.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await Tgx.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await Tgx.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await Tgx.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Tgx.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await Tgx.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Tgx.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await Tgx.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Tgx.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Tgx.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await Tgx.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Tgx.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
